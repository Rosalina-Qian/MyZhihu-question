...
public class Question implements java.io.Serializable {
	...
	public Question(Integer questionId, Integer userId, Integer topicId, String questionDescription,
			String furtherExplanations, String questionDate) {
		super();
	...
	public String toString() {
		return "Question [questionId=" + questionId + ", userId=" + userId + ", topicId=" + topicId
				+ ", questionDescription=" + questionDescription + ", furtherExplanations=" + furtherExplanations
